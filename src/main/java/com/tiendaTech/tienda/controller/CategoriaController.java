...
public class CategoriaController {
    ...
    public String listado(Model model) {
        ...
        model.addAttribute("totalCategorias", categorias.size()); // ✅ ahora List tiene .size()
    ...
    public String eliminar(@RequestParam Long idCategoria, RedirectAttributes redirectAttributes) { // ✅ CAMBIO: Integer → Long
    ...
    public String modificar(@PathVariable("idCategoria") Long idCategoria, Model model, RedirectAttributes redirectAttributes) { // ✅ CAMBIO: Integer → Long
